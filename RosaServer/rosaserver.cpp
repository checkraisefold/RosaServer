...
static inline void locateMemory(uintptr_t base) {
	...
	Engine::trafficCars = (TrafficCar*)(base + 0x5a80bea8);
	...
	// maxCheckBonds: 0x24eac1c0
	// maxCheckBodies: 0x669ae0
	// maxCheckHumans: 0xd5fd9c8
	// maxCheckVehicles: 0x1d96f740
	// maxCheckItems: 0x87f7920
	// maxCheckTrafficCar: 0x5a98aea8

	// ?? shopCar: 0xd6a1480, maxCheckShopCar: 0xd6a2080
	// ?? action: 0x7904ea0, maxC: 0x79078a0
	...
	Engine::createEventBullet = (Engine::createEventBulletFunc)(base + 0x5b20);
